...
--				returns header row for fb numeric measure export
--			    
-- History:		v1
-- =============================================
CREATE PROCEDURE [dbo].[export_feedback_num_headers]
...
from dbo.get_feedback_measure_function(@Assessment_ID, 0, @cv) as m left JOIN
