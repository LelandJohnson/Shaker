...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[10] 4[34] 2[29] 3) )"
      End
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 54
         ...
         Width = 1500
         Width = 1500
', 'SCHEMA', N'dbo', 'VIEW', N'vw_export_basecolumns', NULL, NULL
GO
...
DECLARE @xp int
SELECT @xp=2
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_export_basecolumns', NULL, NULL
GO
